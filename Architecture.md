...
Successful redirects update analytics counters with an atomic repository update instead of mutating the loaded entity. This reduces persistence-context work and makes the counter increment safer under concurrent redirect traffic while keeping the current aggregate analytics model.
